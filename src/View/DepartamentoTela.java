 ...
 * @author Casa
 */
public class DepartamentoTela extends javax.swing.JFrame {
    private Usuario user;
    public DepartamentoTela() {
        initComponents();
    }
    
    public DepartamentoTela(Usuario user) {
        initComponents();
        this.user = user;
    }
    ...
    private void initComponents() {
        ...
        jMAddDisciplina.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMAddDisciplinaActionPerformed(evt);
            }
        });
        ...
        jMenuItem2.setText("Gerar historico");
    ...
    private void jMFormarTurmaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMFormarTurmaActionPerformed
        final jifFormarTurma telaFormaTurma = new jifFormarTurma();
    ...
    private void jMAlunoDisciplinaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMAlunoDisciplinaActionPerformed
        ...
        jDpDepartamento.add(telaCadastroTurma);
        telaCadastroTurma.show();
    }//GEN-LAST:event_jMAlunoDisciplinaActionPerformed

    private void jMAddDisciplinaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMAddDisciplinaActionPerformed
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        final jifHistorico telaHistorico = new jifHistorico(this.user);
        jDpDepartamento.add(telaHistorico);
        telaHistorico.show();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DepartamentoTela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DepartamentoTela().setVisible(true);
            }
        });
    }
