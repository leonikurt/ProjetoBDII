 ...
 * @author Casa
 */
public class DepartamentoMain extends javax.swing.JFrame {

    public DepartamentoMain() {
        initComponents();
    }
    ...
    private void jMAlunoDisciplinaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMAlunoDisciplinaActionPerformed
        final jifCadastroAD telaCadastroAD = new jifCadastroAD();
    ...
    private void jMAddDisciplinaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMAddDisciplinaActionPerformed
        final jifDisciplina telaDisciplina = new jifDisciplina();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DepartamentoMain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DepartamentoMain().setVisible(true);
            }
        });
    }
